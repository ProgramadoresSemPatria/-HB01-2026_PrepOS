  ...
  if (isError || !context) {
    return (
      <div className="bg-red-500/10 border border-red-500/20 p-8 rounded-2xl text-center max-w-2xl mx-auto mt-10">
        ...
        <button
          onClick={() => navigate(-1)}
          className="inline-flex items-center gap-2 bg-[#202020] hover:bg-[#2a2a2a] border border-gray-700 text-white font-medium py-2 px-6 rounded-lg transition-colors"
        >
    ...
    <div className="w-full max-w-4xl mx-auto pb-12">
      <div className="bg-[#202020] border border-gray-800 shadow-2xl rounded-2xl overflow-hidden">
        ...
        <div className="bg-[#171717] border-b border-gray-800 px-8 py-6 relative">
          <button
            onClick={() => navigate(-1)}
            className="text-gray-500 hover:text-[#3ecf8e] text-sm mb-4 flex items-center gap-2 transition-colors font-medium"
          >
            <ArrowLeft size={16} /> Voltar para a Análise
          </button>
